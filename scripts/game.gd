...
func _on_enemy_spawn_timer_timeout():
	...
	# If the spawned enemy is DiverEnemy, you can explicitly set properties
	if e.is_diver_enemy:
		e.speed = 200  # Ensure the DiverEnemy has the correct speed
		e.hp = 1  # DiverEnemy takes 1 shot to die
